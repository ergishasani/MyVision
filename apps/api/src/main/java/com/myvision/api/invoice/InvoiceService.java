...
import com.myvision.api.quote.Quote;
import com.myvision.api.quote.QuoteItem;
...
public class InvoiceService {
  ...
  @Transactional
  public InvoiceResponse createFromQuote(Quote quote, List<QuoteItem> quoteItems) {
