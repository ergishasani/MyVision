...
// Does not extend BaseEntity: delivery_note_items has no updated_at column, matching quote_items.
@Entity
...
public class DeliveryNoteItem {
  ...
  @Column(name = "delivery_note_id", nullable = false, updatable = false)
